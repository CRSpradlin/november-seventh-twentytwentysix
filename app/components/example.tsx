  ...
  return (
    <div className="bg-background w-full">
      <div
        ...
        className={cn(
          "mx-auto grid min-h-screen w-full max-w-4xl min-w-0 content-center items-start gap-8 p-4 pt-2 sm:gap-12 sm:p-6 md:grid-cols-2 md:gap-8 lg:p-12 2xl:max-w-6xl",
          className
        )}
        {...props}
      />
